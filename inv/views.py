...
class CategoriaEdit(SuccessMessageMixin,SinPrivilegios,generic.UpdateView):
    ...
    form_class=CategoriaForm
    success_url=reverse_lazy("inv:categoria_list")
    success_message="categoria actulizado satisfactoriamente"
...
class SubCategoriaEdit(SuccessMessageMixin,SinPrivilegios,generic.UpdateView):
    ...
    form_class=SubCategoriaForm
    success_url=reverse_lazy("inv:subcategoria_list")
    success_message="sub categoria actulizada correctamente"
...
class SubCategoriaDel(SuccessMessageMixin,SinPrivilegios,generic.DeleteView):
    ...
    context_object_name="obj"
    success_url=reverse_lazy("inv:subcategoria_list")
    success_message="sub categoria eliminada correctamente"
...
def um_inactivar(request,id):
    ...
    if request.method=='POST':
        um.estado=False
        um.save()
        messages.success(request,'Unidad inactivada ')
        return redirect("inv:um_list")
